                    ...
                    <div className="h-full bg-white  ">
                        ...
                        <nav className="mt-6">
                            <div>
                                ...
                                <LinkMenu href={`/app/${router?.query?.tenantId}/account/`}>
                                    <span className="text-left">
                        ...
                        <div className="relative z-20 flex flex-col justify-end h-full px-3 md:w-full">
                            <div className="relative flex items-center justify-end w-full p-1 space-x-4">
                                ...
                                <span className="relative block">
                                    <img alt={name} src={image} className="mx-auto object-cover rounded-full h-10 w-10 " />
                                </span>
                                <button className="flex items-center text-gray-500 text-md" onClick={() => {
                                    signOut({callbackUrl: "/"})
                                    router.push('/')
                                }}>
                                    {session?.user?.name}
